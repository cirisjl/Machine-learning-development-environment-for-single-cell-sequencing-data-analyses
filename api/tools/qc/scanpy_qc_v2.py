...
def run_scanpy_qc_v2(adata, unique_id, min_genes=200, max_genes=None, min_cells=3, target_sum=1e4, n_top_genes=None, expected_doublet_rate=0.076, regress_cell_cycle=False, fig_path=None):
        if adata is None:
