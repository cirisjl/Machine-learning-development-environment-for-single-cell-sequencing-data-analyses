...
```{r Seurat, error=TRUE, include=TRUE, echo=params$show_code, include=FALSE, warning=params$show_warning, message=params$show_message}
...
```{r Harmony, error=TRUE, include=TRUE, echo=params$show_code, include=FALSE, warning=params$show_warning, message=params$show_message}
if("HARMONY" %in% methods) {
  ...
  SaveH5Seurat(srat.harmony, filename = params$output_folder, overwrite = TRUE, verbose = FALSE)
...
```{r Liger, error=TRUE, include=TRUE, echo=params$show_code, include=FALSE, warning=params$show_warning, message=params$show_message}
if("LIGER" %in% methods) {
  library(rliger)
  ...
  SaveH5Seurat(srat.liger, filename = params$output_folder, overwrite = TRUE, verbose = FALSE)
