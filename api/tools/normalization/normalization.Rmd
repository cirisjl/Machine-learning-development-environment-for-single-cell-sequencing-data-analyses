  ...
  if(!"SCT" %in% names(x = srat)){
    ...
    if("SCT"  %in% methods){
      ...
      tryCatch({
        ...
        RedisWarning(unique_id, paste0("An error happened during SCTransform VST V2 normalization, skipped: ", e$message))
      }) 
    }
  } else {
