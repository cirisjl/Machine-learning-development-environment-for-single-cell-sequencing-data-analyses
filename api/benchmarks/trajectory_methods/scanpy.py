...
def scanpy_trajectory(adata, benchmarksId, datasetId, task_type='Trajectory', cell_type_label='labels', bm_traj='benchmark_traj'):
    # Start monitoring
    monitor = Monitor(1)
    ...
    ged_score, gks_score, jsc_score, ted_score = trajectory_metrics(adata.uns['trajectory'], adata.uns[bm_traj], adata.uns["iroot"])
