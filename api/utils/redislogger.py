...
class RedisLogger:
    def __init__(self):
        pool = redis.ConnectionPool(host='oscb-redis', port=6388, password='eYVX7EwVmmxKPCDmwMtyKVge8oLd2t81', db=0)
        self.r = redis.Redis(connection_pool=pool)
        # self.r = redis.Redis(host='oscb-redis', port=6388, password='eYVX7EwVmmxKPCDmwMtyKVge8oLd2t81', db=0)
