...
app.use(cors({
    ...
    origin: [`http://${process.env.HOST_URL}`, `http://${process.env.HOST_URL}:3000`, `http://${hostIp}:3000`, `http://${process.env.HOST_URL}:3001`, `http://${hostIp}:3001`, `http://${process.env.HOST_URL}/node/`, `http://${hostIp}/node/`],
